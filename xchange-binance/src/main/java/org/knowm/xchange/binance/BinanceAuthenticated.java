...
public interface BinanceAuthenticated extends Binance {
  ...
  List<BinanceTrade> myMarinTrades(
      @QueryParam("symbol") String symbol,
      @QueryParam("isIsolated") IsIsolated isIsolated,
      @QueryParam("orderId") Long orderId,
      @QueryParam("startTime") Long startTime,
      @QueryParam("endTime") Long endTime,
      @QueryParam("fromId") Long fromId,
  ...
  BinanceNewOrder newMarginOrder(
      @FormParam("symbol") String symbol,
      @FormParam("isIsolated") IsIsolated isIsolated,
      @FormParam("side") OrderSide side,
      @FormParam("type") OrderType type,
      @FormParam("timeInForce") TimeInForce timeInForce,
      @FormParam("quantity") BigDecimal quantity,
  ...
  List<BinanceCancelledOrder> cancelAllOpenMarginOrders(
      @QueryParam("symbol") String symbol,
      @QueryParam("isIsolated") IsIsolated marginAccountType,
      @QueryParam("recvWindow") Long recvWindow,
      @QueryParam("timestamp") SynchronizedValueFactory<Long> timestamp,
      @HeaderParam(X_MBX_APIKEY) String apiKey,
      @QueryParam(SIGNATURE) ParamsDigest signature)
