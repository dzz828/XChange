...
public class BookTickerBinanceWebsocketTransactionTest {
  ...
  public void test_deserialization_of_transaction_message() throws IOException {
    ...
    assertThat(BinanceAdapters.adaptSymbol(tickerTransaction.getTicker().getSymbol(), BinanceAdapters.SPOT))
        .isEqualTo(BinanceAdapters.adaptSymbol("BNBUSDT", BinanceAdapters.SPOT));
